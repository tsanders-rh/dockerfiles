...
install -m 755 mediawiki123:latest/entrypoint.sh %{buildroot}%{_bindir}
install -m 644 mediawiki123:latest/mediawiki123.conf %{buildroot}%{_datadir}/%{name}/mediawiki123.conf.example
